...
S.OptotagPulseNum = 1;
S.ITIMin_optotag = 2; % different ITI for optotagging trials (uniform distribution)
S.ITIMax_optotag = 4;
...
waveform_optotag(1:(S.OptotagPulseDuration * SR)) = 5;
