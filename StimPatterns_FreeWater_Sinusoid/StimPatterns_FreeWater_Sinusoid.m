function StimPatterns_FreeWater_Sinusoid
...
TargetChunkSize = 5; % trials; chunk size in which to balance trial types
...
NumChunks1 = ceil(NumStimTrials/ActualChunkSize);
TrialTypes = [];
for i = 1:NumChunks1
...
offset = A + FR_min;
t = (0:t_end*SR)/SR;
target = FR_func_sinusoid(t, freq, A, offset);
waveform_4secSinusoid_freq025 = PulseTrain(target, t, S.PulseDur);
W.loadWaveform(4,waveform_4secSinusoid_freq025);

% 5) 4 second sinusoid, freq=0.50:
freq = 0.5;
t_end = 4;
FR_min = 10;
FR_max = 30;
...
t = (0:t_end*SR)/SR;
target = FR_func_sinusoid(t, freq, A, offset);
waveform_4secSinusoid_freq050 = PulseTrain(target, t, S.PulseDur);
W.loadWaveform(5,waveform_4secSinusoid_freq050);

% 6) 4 second sinusoid, freq=0.75:
freq = 0.75;
t_end = 4;
FR_min = 10;
FR_max = 30;
...
t = (0:t_end*SR)/SR;
target = FR_func_sinusoid(t, freq, A, offset);
waveform_4secSinusoid_freq075 = PulseTrain(target, t, S.PulseDur);
W.loadWaveform(6,waveform_4secSinusoid_freq075);
...
S.stimWaveforms = {waveform_rampUp,waveform_rampDown,waveform_3secSquare_20Hz,...
    waveform_4secSinusoid_freq025,waveform_4secSinusoid_freq050,waveform_4secSinusoid_freq075,};
