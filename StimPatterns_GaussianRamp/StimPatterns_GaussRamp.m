function StimPatterns_GaussRamp
...
% M. Campbell 6/8/2026: Changed for linear ramps approximating the
%   previous exponential ramps
% M. Campbell 6/22/2026: Gaussian ramps
...
stimWaveforms = load('stimWaveforms_gaussRamp.mat');
stimWaveforms = stimWaveforms.stimWaveforms;
assert(numel(S.gamma) == numel(stimWaveforms));
